 ...
 *
 * Controlled input for dollar values with react-hook-form integration.
 * Shows raw number while editing, formatted with $ prefix on blur.
 *
...
/**
 * Currency input with format on blur behavior
