        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <NumberInput
              ...
              tooltip="Enter the total number of visitors you expect in a year. Eligibility affects test precision only; rollout value applies to all annual visitors. If you want to display a different unit of randomization, you can replace 'visitors' in the text field below."
