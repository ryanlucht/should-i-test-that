...
<objective>
Fix design consistency: Apply purple accent (#7C3AED) consistently across all interactive elements.

Purpose: Per 06-CONTEXT.md, purple accent only appears in chart currently but buttons/accents are blue. This plan fixes the inconsistency so primary buttons, focus rings, selected states, and links all use the purple accent.
