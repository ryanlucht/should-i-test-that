...
must_haves:
  truths:
    ...
    - "Chart updates immediately when prior shape changes (live update via store reactivity)"
  ...
  key_links:
    ...
    - from: "src/components/charts/PriorDistributionChart.tsx"
      ...
      via: "useWizardStore priorShape selector"
      pattern: "advancedInputs.*priorShape"
---
...
<task type="auto">
  ...
  <action>
    ...
    - Display:
      ...
      - Note: "This is EVSI minus Cost of Delay — the realistic value of this specific test."
